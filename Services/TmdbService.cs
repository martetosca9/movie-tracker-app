...
public class TmdbService : ITmdbService
{
    ...
    {
        // Try reading from appsettings or environment variable
        var key = _configuration["Tmdb:ApiKey"] ?? Environment.GetEnvironmentVariable("TMDB_API_KEY");
    ...
    private static List<TmdbMovieDto> GetDemoMovies()
    {
        return new List<TmdbMovieDto>
        {
            new() { Id = 550, Title = "Fight Club", Overview = "Un oficinista insomne y un fabricante de jabón desocupado forman un club de lucha subterráneo.", ReleaseDate = "1999-10-15", VoteAverage = 8.4, PosterPath = "/pB8O2CYJjyqMjYGsB4vR7WvRofw.jpg" },
            new() { Id = 157336, Title = "Interstellar", Overview = "Un grupo de exploradores viaja a través de un agujero de gusano en el espacio en un intento por asegurar la supervivencia de la humanidad.", ReleaseDate = "2014-11-05", VoteAverage = 8.4, PosterPath = "/gEU2QniE6E77NI6lCU6MxlNBvIx.jpg" },
            new() { Id = 27205, Title = "Inception", Overview = "Dom Cobb es un ladrón capaz de adentrarse en los sueños para robar secretos del subconsciente.", ReleaseDate = "2010-07-15", VoteAverage = 8.4, PosterPath = "/oYuLEydvwzK8oA9AJeYyARxWvXt.jpg" },
            new() { Id = 693134, Title = "Dune: Part Two", Overview = "Paul Atreides se une a Chani y a los Fremen mientras busca venganza contra los conspiradores que destruyeron a su familia.", ReleaseDate = "2024-02-27", VoteAverage = 8.3, PosterPath = "/czembW0Rk1Ke7jA4Y2fOHmTeEav.jpg" }
        };
    }
}
